...
BOT_NAME: process.env.BOT_NAME || "PK-XMD",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254712999555",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "pk Driller",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ pk driller*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://res.cloudinary.com/dtjjgiitl/image/upload/q_auto:good,f_auto,fl_progressive/v1753235428/gcxruqnmralvuwx9nsgn.jpg",
